...
def problem3b(m, point1):
    ...
    n = 3
    sum_of_thickness = 0
    point_x_start = point1.x
    point_y_start = point1.y
    for k in range (m):
        T = problem3a(window,point1, n)
        sum_of_thickness = sum_of_thickness + T
        point1.y = point_y_start + 60*(k+1)
        point1.x = point_x_start
        n = n + 2
